...
# 2000 BIRTH COHORT - AGE RANGE 0-100 - LOW FERTILITY SCENARIO
...
# folder.baseseed <- paste0(folder,"/sim_results_socsim_NOR.sup_", supfile, "_",base_seed,"_/")
...
png(file = paste0(graph.folder, "seqF100_5_lab.png"),
    width=w, height=h)
...
plot(srfchi4, which.plot = "medoids", skipar = TRUE, main = l4, cex.main = 1, info = "none", xlab = "Age")
